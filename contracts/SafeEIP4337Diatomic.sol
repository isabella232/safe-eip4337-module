...
contract SafeEIP4337Diatomic is HandlerContext {
    ...
    function validateUserOp(
        ...
        require(safeAddress == msg.sender, "Can be only called through the Safe");
        ...
        require(safeNonce == userOp.nonce, "Nonce mismatch");
        ...
        require(userOp.requiredPreFund() >= requiredPrefund, "Prefund quoted by the entrypoint is larger than one in the operation");
    ...
    function execTransaction(
        ...
        require(
            transactionsReadyToExecute[safeAddress] == getIntermediateTransactionHash(callData, safeNonce, entryPoint, block.chainid),
        ...
        require(success, "Execution error: transaction failed");
    }
    ...
    /// @dev Validates that the user operation is correctly signed. Users methods from Gnosis Safe contract
    /// @param entryPoint Address of the entry point
    /// @param userOp User operation struct
