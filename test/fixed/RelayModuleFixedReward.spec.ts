...
describe('RelayModuleFixedReward', async () => {
    ...
    describe('relayTransaction', async () => {
        it('should require enabled module', async () => {
            ...
            await expect(module.relayTransaction(executor.address, execTransactionData, user2.address)).to.be.revertedWith(
        ...
        it('should check if payment happened', async () => {
            ...
            await expect(module.relayTransaction(mock.address, execTransactionData, user2.address)).to.be.revertedWith(
        ...
        it('should only allow defined method', async () => {
            ...
            await expect(module.relayTransaction(executor.address, execData, user2.address)).to.be.revertedWith('InvalidRelayData()')
            await expect(await hre.ethers.provider.getBalance(executor.address)).to.be.equals(parseEther('0.005'))
        })
